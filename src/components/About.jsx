  ...
  return (
    <div className="w-full p-[5vw] bg-black rounded-tl-3xl rounded-tr-3xl text-white">
      ...
      <div className="flex gap-5 w-full border-t-[1px] pt-[3vw] border-[#99aa5d] mt-[4vw]">
        <div className="w-1/2">
          <h1 className="text-[5vw] text-[#205eab]">New Article:</h1>
          <a
          ...
          >
            <button className="flex gap-5 items-center px-[2vw] py-[1vw] bg-[#205eab] mt-[0.8vw] rounded-full text-white uppercase">
              Buy Now
