    ...
    >
          ...
          return (
            <div key={index} className="masker ">
              <div className="w-fit flex items-center overflow-hidden">
                ...
                <h1 className='uppercase text-[8.5vw] leading-[7vw] tracking-tighter font-["Founders_Grotesk] font-medium'>
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className="border-t-[1px] border-zinc-800 mt-[6vw] flex justify-between items-center py-5 px-20">
        ...
        <div className="start flex items-center gap-4">
          <div className="px-5 py-2 border-[2px] rounded-full border-zinc-500 font-light text-md uppercase cursor-pointer">
            Start the project
          </div>
